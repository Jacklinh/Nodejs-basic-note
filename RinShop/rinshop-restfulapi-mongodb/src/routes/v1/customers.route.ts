...
router.get('', authenticateToken,authorizationAccess(ROLES.VIEW),customersController.findAll);
//2. Get One customers
//GET localhost:8000/api/v1/customers/:id
router.get('/:id',authenticateToken,authorizationAccess(ROLES.VIEW),customersController.findByID)
