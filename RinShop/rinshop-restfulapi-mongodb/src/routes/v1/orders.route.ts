...
router.get('/:id',authenticateToken,authorizationAccess(ROLES.VIEW),ordersController.findByID)
//3. Create a new staff
//POST localhost:8000/api/v1/orders
router.post('',authenticateToken,authorizationAccess(ROLES.MODIFY),ordersController.createRecord)
//4. Update a staff
